...
function Navbar() {
       ...
       useEffect(()=>{
        if(theme==="dark"){
          ...
          const navItems=(<>
                   <li><a className='underline-offset-0 hover:bg-black hover:text-white' href='/'>Home</a></li>
      <li><a className='hover:bg-black hover:text-white' href='/course'>Course</a></li>
      <li><a className='hover:bg-black  hover:text-white' href='/contact'>Contact</a></li>
      <li><a className='hover:bg-black hover:text-white' onClick={()=>document.getElementById('my_modal_3').showModal()}>About</a></li>
          </>)
  return (
    <>
  ...
  <label className="input rounded-md flex items-center gap-2 " style={{ backgroundColor: '#f1f2f6', color: 'white' }}>
